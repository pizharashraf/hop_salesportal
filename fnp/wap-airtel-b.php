...
if($htmssdn)
{
	...
	$body = 'mobile_number='.$htmssdn.'&telco=airtel&text='.$source.':Barista&source=wap&place_id=507e5d1ebbcee317a6000050&place_name=Barista';
  ...
  <div class="white_box">
    <div class="brand">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="center" valign="middle"><img src="img/barista.PNG" alt="" /></td>
