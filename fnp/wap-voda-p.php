...
if($htmssdn)
{
        ...
        $body = 'mobile_number='.$htmssdn.'&telco=tata&text='.$source.':U.S.Pizza&source=wap&place_id=509257fbbbcee34578000006&place_name=U.S.Pizza';
        $c = curl_init ($url);
  ...
  <div class="white_box">
    <div class="brand">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="center" valign="middle"><img src="img/uspizza.jpg" alt="" /></td>
