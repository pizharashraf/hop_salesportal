...
global $base_url;
global $user;
print l('DSR Hierarchy', $base_url.'/y2cf/yourancestors');
?>
...
<div class="mycont_content"><!--               <div class="profile_subhead">&nbsp;</div> -->
<div class="mycont_drow">
<div id="left-pane">
<div class="" id="left-pane-content"><?php
//  0 annonymous users 1 admin 66 y2cfmanager
...
<ul class="simpleTree">
	<li id="0" class="root"><?php createTree($arrayCategories, $user->uid) ?></li>
</ul>
</div>
</div>
<div id="right-pane">
<div id="right-pane-content"><?php
$user_id = arg(2);
print daily_sales_report_per_user($user_id);
//print daily_sales_report($user_id);
?></div>
</div>
</div>
</div>
